...
balls=[]
rand_balls=RandomBalls(dia/2, (SCREEN_WIDTH,SCREEN_HEIGHT))
d_balls=rand_balls.generate_random_balls()
for pos in d_balls.values():
  balls.append( create_ball(dia / 2, pos))
