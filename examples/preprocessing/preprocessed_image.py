...
cv2.imwrite('./results/img_0_undist.jpg', undist_img)
cv2.imwrite('./results/img_0_dist_warp.jpg', warp_distorted)
cv2.imwrite('./results/img_0_undist_warp.jpg', warp_undistorted)