...
img            = cv2.imread(f'./results/corners_0.jpg')
...
cv2.imwrite('./results/warp_corners_dist.jpg', warp_distorted)
cv2.imwrite('./results/warp_corners_undist.jpg', warp_undistorted)